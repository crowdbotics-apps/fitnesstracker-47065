"""
Django settings for fitnesstracker_47065 project.
...
ROOT_URLCONF = 'fitnesstracker_47065.urls'
...
WSGI_APPLICATION = 'fitnesstracker_47065.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fitnesstracker_47065 API",
    "DESCRIPTION": "API documentation for fitnesstracker_47065 App",
    "VERSION": "v1",
}
